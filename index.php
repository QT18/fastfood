...
<body>
    <nav>
        ...
        <ul>
            ...
            <div>
                ...
                ?>
        <form method="post">
            <input type="text" name="search" style="width:70%" row="5" class="form-control" placeholder= "Tìm kiếm tại đây..." value = "<?php if(isset($_GET["search"])) {echo $_GET["search"]; } ?>">
   ...
   <div class="container">
        ...
        foreach ($list as $key => $value) { ?>
            <div class="card">
                <div class="imgBx">
                    <a href="detail.php?id=<?= $value['id'] ?>"><img src="admin/upload/<?= $value['image'] ?>" alt=""></a>
                </div>
                <div class="content">
