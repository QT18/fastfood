...
<body>
    ...
    <div class="container-single">
        <div class="image-product">
            <img src="admin/upload/<?= $result['image'] ?>" alt="">
        </div>
        <div class="info">
            <div class="name">
                <h2><?= $result['name'] ?></h2>
        ...
        <h2>Bình luận</h2>
        <form method="post">
            <section><textarea name = "comment" style="width:100%" row="5" class="form-control" placeholder= "Bình luận tại đây ..."></textarea>
            </section>
            <section>
                <input type="submit" value="Bình luận" class="btn btn-primary"></input>
            </section>
        </form>
    </section>
            </div>
