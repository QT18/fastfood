...
<body>
    ...
    <div class="addNew">
        ...
        <h3><a href="add_product.php" class="btn btn-primary">Thêm mới</a>
    </div>
    <div class="container">
        <?php $count = 1;
        if ($list) { ?>
            <table class="list">
                ...
                <?php foreach ($list as $key => $value) { ?>
                    <tr>
                        <td><?= $count++ ?></td>
                        <td><?= $value['name'] ?></td>
                        <td><img class="image-cart" src="upload/<?= $value['image'] ?>" alt=""></td>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <form action="productlist.php" method="post">
                                    <input type="text" name="id" hidden value="<?= $value['id'] ?>" style="display: none;">
                                    <input type="submit" value="Xóa" name="active">
                                </form>
                            <?php } ?>
                        </td>   
                    </tr>
